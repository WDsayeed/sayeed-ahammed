...
const Data = () => {
  const [text] = useTypewriter({
    words: ['Full Stack Developer', 'Mern stack Developer', 'Front-end Developer', 'React Developer!'],
    loop: true,
        ...
        return (
             <div className="home-data">
                <h1 className="home-title">Sayeed Ahammed
                <svg
                  // width="36"
                  // height="36"
                  viewBox="0 0 48 48"
                ...
                <h3 className="home-subtitle">I'm a <span>{text}</span><Cursor cursorColor='black' /></h3>
                
                <p className="home-description">
                I have one years of experience building and desgining software. Currently, I love to work on web application using technologies like React, Tailwind, Firebase, Node JS and MongoDb.
                </p>
